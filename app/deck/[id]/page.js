...
const initialWordlists = {
  ...
  hsk6: hsk6,
  french: [
    { other: "Bonjour", english: "Hello" },
    { other: "Merci", english: "Thank you" },
    { other: "Au revoir", english: "Goodbye" },
    { other: "Comment ça va?", english: "How are you?" },
    { other: "Je ne parle pas français", english: "I don't speak French" },
    { other: "Je suis fatigué", english: "I am tired" },
    { other: "Je suis en retard", english: "I am late" },
  ],
};
